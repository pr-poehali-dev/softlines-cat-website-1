        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              {['О питомнике', 'Производители', 'Котята', 'Выставки', 'Блог', 'Статьи', 'Контакты'].map((item, idx) => (
                <button
                  key={item}
                  onClick={() => onNavigate(['about', 'producers', 'kittens', 'exhibitions', 'blog', 'articles', 'contacts'][idx])}
